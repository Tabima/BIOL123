...
We will use the local cluster called `SMAUG` (See Figure 1). `SMAUG` is a computer that the Tabima lab hosts that has 32 processors, more than 14 TB of storage and 128 GB of RAM. This is enough to do any kind of analyses.
...
No. We will use R for very basic tasks, like extracting sequences from a large file or counting the number of genes, among other basic operations.
...
*Being resourceful and using the resources we can is very important. Sometimes things won't work as expected and we MUST find an alternative. This is one of those cases*.
