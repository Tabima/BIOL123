...
1. Copy the FASTA file and search for the domains in [InterPro]. When the result appears, answer these questions:
...
4. InterPro now saves the files as compressed files (`gzip files`). We need to uncompressed them. To do this, you need to rename your files by adding a `.gz`, for example:
