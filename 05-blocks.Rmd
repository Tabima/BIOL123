...
## Section 3: How to upload and process local files into the cluster
...
7. Connect to the cluster using terminal/mobaxterm, go to the `Lab_3/mystery_genes` folder and check if the files are there. 
